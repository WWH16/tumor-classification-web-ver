"""
Django settings for tumorclassification project.
...
SECRET_KEY = 'django-insecure-$7jvh&m*ry9aopq#)e1482ou*9+x%+^u1d4dgb&(+z-gxy$i6l'
...
WSGI_APPLICATION = 'tumorclassification.wsgi.application'
